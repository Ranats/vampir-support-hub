    ...
    <div className="policy-shell">
      ...
      <main className="policy-main">
        <div className="policy-heading">
          ...
          <time dateTime="2026-07-31">最終更新：2026年7月31日</time>
        </div>
        ...
        <div className="policy-sections">
          ...
          <section className="policy-card">
            ...
            <ul>
              ...
              <li>クラン共有ポータルでは、作成・変更時にクラン名と曜日・時刻を、閲覧・管理操作時に対応する秘密キーを認証のためAPIへ送信します。</li>
              <li>それ以外の端末内設定（レベル、チェック状況、個人用リマインダー、通知設定など）は、運営者のサーバーへ送信しません。</li>
          ...
          <section className="policy-card">
            <h2>クラン共有ポータル</h2>
            <p>
              個人用クラン予定の曜日・時刻は、共有ポータル作成フォームの初期値として使用します。
              クランマスターが「共有ポータルを作成」を実行した場合だけ、その時点のクラン名と開催曜日・時刻をサーバーのデータベースへ保存します。
