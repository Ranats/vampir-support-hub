    ...
    <div className="policy-shell">
      ...
      <main className="policy-main">
        <div className="policy-heading">
          ...
          <time dateTime="2026-08-19">最終更新：2026年8月19日</time>
        </div>
        ...
        <div className="policy-sections">
          ...
          <section className="policy-card">
            <h2>端末内に保存するデータ</h2>
            <p>
              レベル、日課・週課・イベントミッションのチェック状況、自分で追加した項目、表示設定、イベントボスのサーバー地域、出現通知対象、通知設定、言語設定、通知の重複防止記録、
          ...
          <section className="policy-card">
            ...
            <ul>
              ...
              <li>クラン予定のタイムゾーンはユーザー入力の予定だけに適用します。公式の出現予定は原則JSTで、公式に地域別時刻を確認できたイベントボスだけ、選択したサーバー地域の時刻で表示します。日次・週次リセットはJSTのままです。</li>
