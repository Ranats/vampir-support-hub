...
- Source of truth: `app/HomePage.tsx` for displayed schedules, routines, and localized UI; linked official VAMPIR pages and dated reference articles for factual values.
- Read order: `AGENTS.md`, `app/HomePage.tsx`, `app/(ja)/layout.tsx`, `app/(en)/layout.tsx`, localized policy pages, `app/progress-cycle.ts`, `app/globals.css`, then tests.
